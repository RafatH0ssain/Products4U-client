const SliderExplained = () => {
    return (
        <div className="md:flex justify-between gap-5">
            ...
            <div className="flex flex-col justify-center items-start px-10 border-10 border-black bg-white text-black rounded-3xl md:7/12 w-full h-[500px]">
                <h2 className="text-3xl font-bold mb-8 bg-white mx-auto underline">Why Choose Products4U?</h2>
                <p className="text-xl mb-4 bg-white">
